...
(function (global) {
  ...
  const TYPE_META = {
    ...
    whitewaterKayak: { tl: "급류 카약", bg: "#001828" },
    canyoning: { tl: "캐녀닝", bg: "#0a1810" },
    mtbDownhill: { tl: "MTB 다운힐", bg: "#1a1208" },
    rockClimbing: { tl: "자연 암벽등반", bg: "#181208" },
    highRopes: { tl: "하이로프", bg: "#0a1810" },
    survivalGame: { tl: "서바이벌 게임", bg: "#141808" },
  ...
  const CHIP_CLASS_MAP = {
    ...
    sky: "t-sky",
    jetboat: "t-sky",
    whitewaterKayak: "t-sky",
    canyoning: "t-earth",
    mtbDownhill: "t-earth",
    rockClimbing: "t-earth",
    highRopes: "t-zipline",
    survivalGame: "t-earth",
    shooting: "t-custom",
    speedboat: "t-sky",
    hangglider: "t-sky",
    cave: "t-custom",
